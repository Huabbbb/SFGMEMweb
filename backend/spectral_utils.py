...
def resample_spectrum_for_mem(
    ...
    if mem_points == original_points and original_uniform:
    ...
    info = {
        ...
        "mem_frequency_range": [float(mem_wavenumbers[0]), float(mem_wavenumbers[-1])],
        "resampling_method": method,
        "original_grid_uniform": original_uniform,
        "resampling_note": "Increasing MEM calculation points by interpolation does not add new spectral information.",
    }
